  ...
  projects: Project[] = [
    {
      ...
      description:
        'A digital solution for cost recording on construction sites. The software replaces the previous inefficient Excel-based process, enabling optimized and error-reduced cost recording. Key challenges included integrating various technologies and ensuring a scalable solution..',
      ...
      technologies: [
        ...
        { name: 'MariaDB', icon: 'mariadb.png' },
        { name: 'TypeScript', icon: 'ts.png' },
        { name: 'Single Page Application', icon: 'spa.svg' },
      ],
    },
    {
      title: 'Discord Bot',
      description:
        'A fully customized Discord Bot used by 300+ users built with Python and MariaDB, offering economy, moderation, prediction, and gaming features to engage and entertain server members',
    ...
    },
    {
      ...
      description:
        'A Twitch Bot that displays live music, tracks game stats, monitors chat emotes and integrates Spotify and other APIs to enhance viewer engagement.',
